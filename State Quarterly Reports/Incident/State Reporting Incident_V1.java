...
public class RPS_STATE_REPORTING_INCIDENT_V2 extends ReportJavaSourceNet
{
	...
	private void ProcessStats(final ReportDataGrid grid)
	{
		...
		for( String schoolOid : schoolOids)
		{
			...
			{	
				...
				grid.set(FIELD_SCHOOL, (String) ((SisSchool) getBroker().getBeanByOid(SisSchool.class, schoolOid)).getName());
				grid.set(FIELD_A1	, AllStudent.Weapon       );
				grid.set(FIELD_A2	, AllStudent.OAStudents   );
				grid.set(FIELD_A3	, AllStudent.OAStaff      );
				grid.set(FIELD_A4	, AllStudent.Malicious    );
				grid.set(FIELD_A5	, AllStudent.Alcohol      );
				grid.set(FIELD_A6	, AllStudent.Gang         );
				grid.set(FIELD_A7	, AllStudent.Harrassment  );
				grid.set(FIELD_A8	, AllStudent.Disorderly   );
				grid.set(FIELD_A9	, AllStudent.Threat       );
				grid.set(FIELD_A10	, AllStudent.Arson        );
				grid.set(FIELD_A11	, AllStudent.Attendance   );
				grid.set(FIELD_A12	, AllStudent.Breaking     );
				grid.set(FIELD_A13	, AllStudent.Electronic   );
				grid.set(FIELD_A14	, AllStudent.Extorsion    );
				grid.set(FIELD_A15	, AllStudent.Riot         );
				grid.set(FIELD_A16	, AllStudent.Homicide     );
				grid.set(FIELD_A17	, AllStudent.Other        );
				grid.set(FIELD_A18	, AllStudent.Fighting     );
				grid.set(FIELD_A19	, AllStudent.Sexual 	  );

				grid.set(FIELD_D1	, Disabled.Weapon       );
				grid.set(FIELD_D2	, Disabled.OAStudents   );
				grid.set(FIELD_D3	, Disabled.OAStaff      );
				grid.set(FIELD_D4	, Disabled.Malicious    );
				grid.set(FIELD_D5	, Disabled.Alcohol      );
				grid.set(FIELD_D6	, Disabled.Gang         );
				grid.set(FIELD_D7	, Disabled.Harrassment  );
				grid.set(FIELD_D8	, Disabled.Disorderly   );
				grid.set(FIELD_D9	, Disabled.Threat       );
				grid.set(FIELD_D10	, Disabled.Arson        );
				grid.set(FIELD_D11	, Disabled.Attendance   );
				grid.set(FIELD_D12	, Disabled.Breaking     );
				grid.set(FIELD_D13	, Disabled.Electronic   );
				grid.set(FIELD_D14	, Disabled.Extorsion    );
				grid.set(FIELD_D15	, Disabled.Riot         );
				grid.set(FIELD_D16	, Disabled.Homicide     );
				grid.set(FIELD_D17	, Disabled.Other        );
				grid.set(FIELD_D18	, Disabled.Fighting     );
				grid.set(FIELD_D19	, Disabled.Sexual 	    );

				grid.set(FIELD_E1	, ELL.Weapon       );
				grid.set(FIELD_E2	, ELL.OAStudents   );
				grid.set(FIELD_E3	, ELL.OAStaff      );
				grid.set(FIELD_E4	, ELL.Malicious    );
				grid.set(FIELD_E5	, ELL.Alcohol      );
				grid.set(FIELD_E6	, ELL.Gang         );
				grid.set(FIELD_E7	, ELL.Harrassment  );
				grid.set(FIELD_E8	, ELL.Disorderly   );
				grid.set(FIELD_E9	, ELL.Threat       );
				grid.set(FIELD_E10	, ELL.Arson        );
				grid.set(FIELD_E11	, ELL.Attendance   );
				grid.set(FIELD_E12	, ELL.Breaking     );
				grid.set(FIELD_E13	, ELL.Electronic   );
				grid.set(FIELD_E14	, ELL.Extorsion    );
				grid.set(FIELD_E15	, ELL.Riot         );
				grid.set(FIELD_E16	, ELL.Homicide     );
				grid.set(FIELD_E17	, ELL.Other        );
				grid.set(FIELD_E18	, ELL.Fighting     );
				grid.set(FIELD_E19	, ELL.Sexual       );
			}
		}
		}
		else
	...
	public class Infraction
	{
		...
		public Infraction (String Code, String ID,String State,   Collection<ConductIncident> Inc)
		{
			IncidentCode = Code;
			IncidentID = ID;
			Incidents = Inc; 
